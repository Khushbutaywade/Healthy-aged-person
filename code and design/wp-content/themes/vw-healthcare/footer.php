    ...
    <footer role="contentinfo">
        ...
        <div id="footer-2" class="pt-3 pb-3 text-center">
          	<div class="copyright container">
                ...
                <?php if( get_theme_mod( 'vw_healthcare_footer_scroll',true) != '' || get_theme_mod( 'vw_healthcare_resp_scroll_top_hide_show',true) != '') { ?>
                    <?php $vw_healthcare_theme_lay = get_theme_mod( 'vw_healthcare_scroll_top_alignment','Right');
                    if($vw_healthcare_theme_lay == 'Left'){ ?>
                        <a href="#" class="scrollup left"><i class="fas fa-long-arrow-alt-up p-3"></i><span class="screen-reader-text"><?php esc_html_e( 'Back To Top', 'vw-healthcare' ); ?></span></a>
                    <?php }else if($vw_healthcare_theme_lay == 'Center'){ ?>
                        <a href="#" class="scrollup center"><i class="fas fa-long-arrow-alt-up p-3"></i><span class="screen-reader-text"><?php esc_html_e( 'Back To Top', 'vw-healthcare' ); ?></span></a>
                    <?php }else{ ?>
                        <a href="#" class="scrollup"><i class="fas fa-long-arrow-alt-up p-3"></i><span class="screen-reader-text"><?php esc_html_e( 'Back To Top', 'vw-healthcare' ); ?></span></a>
                    <?php }?>
                <?php }?>
          	</div>
          	<div class="clear"></div>
