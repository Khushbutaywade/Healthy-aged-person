jQuery(document).ready(function($) {
    'use strict';
    var this_obj = vw_healthcare_plugin_activate_plugin;
    ...
    $(document).on('click', '.vw-healthcare-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message vw-healthcare-plugin-install');
                button.addClass('button-primary vw-healthcare-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.vw-healthcare-recommended-plugins .vw-healthcare-activation-note').css('display','block');
    ...
    $(document).on('click', '.vw-healthcare-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .vw-healthcare-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .vw-healthcare-recommended-plugins').css('display','none');
    });
